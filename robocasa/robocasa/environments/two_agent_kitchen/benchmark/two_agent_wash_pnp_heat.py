...
import robocasa.macros as macros # use private macros to debug


class TwoAgentWashPnPHeat(TwoAgentKitchen):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # kwargs["style_ids"] = [0, 2, 3, 4, 7, 8, 11] # for big sink, obj_x_percent: 0.63
        kwargs["style_ids"] = [1, 5, 6, 9, 10] # for small sink, obj_x_percent: 0.69
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = f"wash the vegetable in the sink and then heat it in the microwave"
        return ep_meta
    ...
    def _check_success(self):
        ...
        # container = self.objects["container"] # near sink
        # plate = self.objects["plate"] # near microwave
        plate = self.objects["container"] # in microwave
        ...
        # vegetables_in_place = OU.check_obj_in_receptacle(self, "vegetable", "container")
        # don't need to check if vegetables are in the container
        task3_success = self.task2_has_succeeded
        ...
        obj_container_contact = self.check_contact(obj, plate)
        container_micro_contact = self.check_contact(plate, self.microwave)
