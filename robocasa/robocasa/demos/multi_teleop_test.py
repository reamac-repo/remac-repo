...
if __name__ == "__main__":
    ...
    tasks = OrderedDict([
        ...
        # added, self designed
        ("ArrangeItems", "one agent arranges items in the kitchen, " + colored("oneagent singletask", "yellow")), 
        ("PnPCounterToCounter", "pick the object from the counter and place it in the plate, " + colored("oneagent singletask, ", "yellow") + colored("has default controller", "green")),
        ("TwoAgentArrange", "two agents arrange items in the kitchen, " + colored("twoagent singletask", "yellow")),
        ("TwoAgentSteamInMicrowave", "pick the vegetable and place it in the bowl, steam them in the microwave, " + colored("twoagent singletask", "yellow")),

        # added, use for benchmarking
        ("OpenMicrowavePnP", "open microwave door, pick the food and place it in the microwave, " + colored("oneagent benchmark", "blue")),
        ("HeatOnStove", "place the vegetable and pan on the stove, then turn on the stove burner for the pan, " + colored("oneagent benchmark", "blue")),
        ("DefrostInBowl", "place the bowl and vegetable in the sink, then turn on and off the faucet, " + colored("oneagent benchmark", "blue")),
        ("OpenCabinetPnP", "open cabinet door, pick the food and place it in the cabinet, " + colored("oneagent benchmark", "blue")),
        ("WashPnPHeat", "wash the vegetable in the sink, then pick and steam it in the microwave, " + colored("oneagent benchmark", "blue")),
        ("TwoAgentOpenMicrowavePnP", "two agents open microwave door, pick the food and place it in the microwave, " + colored("twoagent benchmark", "blue")),
        ("TwoAgentHeatOnStove", "two agents place the vegetable and pan on the stove, then turn on the stove burner for the pan, " + colored("twoagent benchmark", "blue")),
        ("TwoAgentDefrostInBowl", "two agents place the bowl and vegetable in the sink, then turn on and off the faucet, " + colored("twoagent benchmark", "blue")),
        ("TwoAgentOpenCabinetPnP", "two agents open cabinet door, pick the food and place it in the cabinet, " + colored("twoagent benchmark", "blue")),
        ("TwoAgentWashPnPHeat", "two agents wash the vegetable in the sink, then pick and steam it in the microwave, " + colored("twoagent benchmark", "blue")),
    ])
