...
def run_rollout_multitask_twoagent(
        ...
        verbose=False,
        env_lang=None, # "agent0 task0_lang, agent1 task1_lang, ..."
        reset_arm=True
    ):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        default=['checkpoints/agent0_ckpt.pth', 'checkpoints/agent1_ckpt.pth'],
        # required=True,
    ...
    parser.add_argument(
        "--env",
        type=str,
        default='TwoAgentWashPnPHeat', # None
    ...
    # whether reset arm to initial position and orientation after each task
    parser.add_argument(
        "--reset_arm",
        type=bool,
        default=True, # None by default
        help="(optional) reset arm to initial position and orientation after each task",
    )
